...
sched.add_job(one_off_tweet, 'interval', minutes=1, start_date='2018-01-08 21:15:00')
...
# sched.add_job(produce_tweets, 'interval', days=1, start_date='2018-01-08 21:03:00')
sched.start()
